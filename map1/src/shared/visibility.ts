export function makePlayerInvisible(player: Player) {
  changeTransparency_exceptGhostOutfit(player, 1);
}

export function makePlayerVisible(player: Player) {
  changeTransparency_exceptGhostOutfit(player, 0);
}

function changeTransparency_exceptGhostOutfit(player: Player, transparency: number) {
